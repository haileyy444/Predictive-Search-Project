...
function search(str) {
	...
	// TODO
	//takes input and sees if it .includes a fruit or any part of it and returns as an array of results
	...
	//uses inputVal sent from searchHandler
	return results;
}
...
function searchHandler(e) {
	...
	showSuggestions(results, inputVal); //need some way to initiate showing results when the person starts to input stuff
}
...
function showSuggestions(results, inputVal) {
	...
	results.forEach(result => {
        ...
        // memeList.appendChild(memeImage);
